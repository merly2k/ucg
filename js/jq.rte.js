    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                ...
                <p>\
                    <a href='#' class='bold ss_sprite ss_text_bold '> </a>\
                    <a href='#' class='italic ss_sprite ss_text_italic '> </a>\
                </p>\
                <p>\
                    <a href='#' class='unorderedlist ss_sprite ss_text_list_bullets '> </a>\
                    <a href='#' class='link ss_sprite ss_link'> </a>\
                    <a href='#' class='image ss_sprite ss_images'> </a>\
                    <a href='#' class='disable ss_sprite ss_plugin_disabled'> </a>\
                </p></div></div>");
