...
$db = new db();
$zapros = "SELECT  `id`, `razdel`, `base_url`,  `pravilo` FROM `rss_sites` where `login`='" . $_SESSION['username'] . "' and `id`='$task_id'";
//echo $zapros;
$db->get_rows($zapros);
//print_r($db->result[0]);
extract($db->result[0]);
